...
public class Block {
	...
	protected double halfwidth; // Halfwidth of block (the block radius is sqrt(2)*h).

	/** Body-frame position --- needed for contact processing. */
	protected Point2d position; // Center of the block (in the image coordinate system)
