...
public class BoundingBoxTest {
	...
	public void testOverlaps() {
		...
		//case 6: share sides, in box
		Vector2D one1 = new Vector2D(0,0);
		Vector2D two2 = new Vector2D(10,10);
		BoundingBox BBox10 = new BoundingBox(one1,two2);
		
		Vector2D three3 = new Vector2D(0,0);
		Vector2D four4 = new Vector2D(2,2);
		BoundingBox BBox11 = new BoundingBox(three3,four4);
		
		assertEquals(true, BBox10.overlaps(BBox11));
