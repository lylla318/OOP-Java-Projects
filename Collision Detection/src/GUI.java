/* Time spent on a4:  20 hours and 0 mm minutes.

 * Name: Lylla Younes
 * Netid: ley23
 * What I thought about this assignment:
 * The bad news is the bulk of the time I spent on this assignment
 * was spent on very nit-picky mistakes that took a few lines or less to fix.
 * The good news it that this was an excellent and very important assignment.
 * I finally understand what it means to find an algorithm.
 * I know what it means to be a computer scientist and not just a programmer.
 * I spent a lot of time just thinking and drawing instead of coding.
 * So I feel like I learned to think computationally in a way that I haven't before.
 * INCREDIBLY FRUSTRATING BUT GREAT ASSIGNMENT.
 */
