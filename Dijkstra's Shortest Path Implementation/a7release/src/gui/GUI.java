...
/** An instance is the JFrame that shows the map.
 * Class game.Main and perhaps other classes send updates to the gui
...
public class GUI extends JFrame{
    ...
    private Board board;       // The board this gui draws
    ...
    private LinkedList<Node> path; // the path highlighted in red on GUI (null if none)
    ...
    public int setColors(LinkedList<Node> path, Color c) {
    ...
    public void fixMenuBar() {
        ...
        mntmRandom.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                ...
                board= Board.randomBoard(returnVal);
                setBoard(board);
                startNode= null;
                endNode= null;
                spInfo.setText("");
