...
public class A2Tester {
	...
	public void testFixName(){
		String s0 = "    David Gries";
		assertEquals("Gries, David",A2.fixName(s0));
		String s1 = "sid       chaudhuri ";
		assertEquals("Chaudhuri, Sid",A2.fixName(s1));
		String s2 = "James Arthur Gosling";
		assertEquals("Gosling, James A.",A2.fixName(s2));
		String s3 = "x x x";
		assertEquals("X, X X.",A2.fixName(s3));
