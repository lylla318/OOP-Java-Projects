...
/* Time spent on a2:  06 hours and 35 minutes.

 * Name: Lylla Younes
 * Netid: ley23
 * What I thought about this assignment: Such a great assignment! I really understand the concept of
 * pointers now. I feel like I am also far less confused about static functions. This assignment 
 * was not incredibly challenging, but I learned a ton. Should definitely keep doing this
...
public class LinkedList<E> {
	...
	public Node insertBefore(E v, Node n) {
		...
		if (size == 1){
			Node newNode = new Node(null, n, v);
			this.first = newNode;
			this.last = n;
			n.next = null;
			n.prev = newNode;
			...
			Node newNode = new Node(n.prev, n, v);
			n.prev.next = newNode;
			n.prev = newNode;
			size++;
			return newNode;
	...
	public void remove(Node n) {
		...
		if (size == 1){
			...
			this.last = null;
			size--;
		} else if (size == 2 && (n == this.getFirst())){
			this.getLast().prev = null;
			this.first = getLast();
			n.next = null;
			n.prev = null;
			size--;
		} else if (size == 2 && (n == this.getLast())){
			this.getFirst().next = null;
			this.last = getFirst();
			n.next = null;
			n.prev = null;
			size--;
