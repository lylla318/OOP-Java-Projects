...
public class LinkedListTester {
	...
	public void testInsertBefore() {
		LinkedList<Integer> LL0 = new LinkedList<Integer>();
		LL0.append(1);
		LL0.insertBefore(2, LL0.getFirst());
		assertEquals("(2, 1)", LL0.toString());
		assertEquals("(1, 2)", LL0.toStringReverse());
		assertEquals(2, LL0.size());
		
		LinkedList<Integer> LL1 = new LinkedList<Integer>();
		LL1.append(1);
		LL1.append(3);
		LL1.insertBefore(2, LL1.getFirst());
		assertEquals("(2, 1, 3)", LL1.toString());
		assertEquals("(3, 1, 2)", LL1.toStringReverse());
		assertEquals(3, LL1.size());
		
		LinkedList<Integer> LL2 = new LinkedList<Integer>();
		LL2.append(1);
		LL2.append(2);
		LL2.insertBefore(3, LL2.getLast());
		assertEquals("(1, 3, 2)", LL2.toString());
		assertEquals("(2, 3, 1)", LL2.toStringReverse());
		assertEquals(3, LL2.size());
	...
	public void testRemove() {
		...
		LL1.append(1);
		LL1.append(2);
		LL1.remove(LL1.getFirst());
		assertEquals("(2)", LL1.toString());
		assertEquals("(2)", LL1.toStringReverse());
		assertEquals(1, LL1.size());
		
		LinkedList<Integer> LL2 = new LinkedList<Integer>();
		LL2.append(1);
		LL2.append(2);
		LL2.remove(LL2.getLast());
		assertEquals("(1)", LL2.toString());
		assertEquals("(1)", LL2.toStringReverse());
		...
		LL3.append(2);
		LL3.append(3);
		LL3.remove(LL3.getFirst().next());
		assertEquals("(1, 3)", LL3.toString());
		assertEquals("(3, 1)", LL3.toStringReverse());
		...
		LL4.append(2);
		LL4.append(3);
		LL4.remove(LL4.getLast().prev());
		assertEquals("(1, 3)", LL4.toString());
		assertEquals("(3, 1)", LL4.toStringReverse());
		...
		LL5.append(2);
		LL5.append(3);
		LL5.remove(LL5.getFirst());
		assertEquals("(2, 3)", LL5.toString());
		assertEquals("(3, 2)", LL5.toStringReverse());
